...
import com.example.modules.admin.dto.UmsAdminParam;
import com.example.modules.admin.dto.UpdateAdminPasswordParam;
import com.example.modules.admin.mapper.UmsAdminLoginLogMapper;
...
public class UmsAdminServiceImpl extends ServiceImpl<UmsAdminMapper, UmsAdmin> implements UmsAdminService {
    ...
    public UmsAdmin getAdminByUsername(String username) {
        ...
        boolean temp=adminCacheService.isExistConcurrencyByUserName(username);
        if (temp==false){
            adminCacheService.setConcurrencyByUserName(admin.getUsername(),admin.getConcurrency());
        }
        return admin;
    }
