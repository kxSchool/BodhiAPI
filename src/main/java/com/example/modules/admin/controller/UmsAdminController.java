...
import com.example.modules.admin.dto.UmsAdminLoginParam;
...
public class UmsAdminController {
    ...
    @ResponseBody
    public CommonResult updateRole(@RequestBody Map<String, Object> param) {

        int count = adminService.updateRole((Long) param.get("adminId"), (List<Long>) param.get("roleIds"));
        if (count >= 0) {
