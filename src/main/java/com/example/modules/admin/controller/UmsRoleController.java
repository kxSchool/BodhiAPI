...
public class UmsRoleController {
    ...
    @ResponseBody
    public CommonResult delete(@RequestBody Map<String, Object> param) {
    ...
    @ResponseBody
    public CommonResult allocMenu(@RequestBody Map<String, Object> param) {
        String roleId=(String)param.get("roleId");
        List<Integer> menuIds=(List<Integer>)param.get("menuIds");
        int count = roleService.allocMenu(Long.valueOf(roleId), menuIds);
    ...
    @ResponseBody
    public CommonResult allocResource(@RequestBody Map<String, Object> param) {
        String roleId=(String)param.get("roleId");
        List<Integer> resourceIds01=(List<Integer>)param.get("resourceIds");
        List<Long> resourceIds=new ArrayList<>();
        resourceIds01.stream().forEach(e->resourceIds.add(Long.valueOf(e)));
        int count = roleService.allocResource(Long.valueOf(roleId), resourceIds);
        return CommonResult.success(count);
    }
